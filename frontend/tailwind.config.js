  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsla(210, 100%, 56%, 0.12) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(189, 100%, 56%, 0.08) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(210, 100%, 56%, 0.06) 0px, transparent 50%)',
      },
    },
  },
  plugins: [],
